from modules.combined_pipeline import combinedPreProcessor
...
from modules.model_selection import classifier,regressor
...
if __name__ == "__main__":
    ...
    preprocessor,X_train,X_test,y_train,y_test = combinedPreProcessor(df,numPipeline,catPipeline)
